...
public:
    ...
    void ivestiDuomenis(bool skaitytiIsFailo) {
        if (!skaitytiIsFailo) {
...
int main() {
    ...
    while (testi == 't' || testi == 'T') {
        cout << "Ar norite skaityti duomenis iš failo? (t/n): ";
        char skaitytiIsFailo;
        cin >> skaitytiIsFailo;

        Studentas naujasStudentas("", "");
        naujasStudentas.ivestiDuomenis(skaitytiIsFailo == 't' || skaitytiIsFailo == 'T');
